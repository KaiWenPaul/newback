    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i>视频发布</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
           ...
           <div class="handle-box add">
             <el-button type="primary" icon="el-icon-edit" class="handle-del mr10" @click="releaseGo">发布视频</el-button>
             <el-button type="primary" icon="delete" class="handle-del mr10" @click="opendelAll">批量删除视频</el-button>
             <el-button type="primary" icon="delete" class="handle-del mr10" @click="exportAll">批量导入视频</el-button>
            ...
            <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="title" :show-overflow-tooltip="true" label="标题" align="center" width="150"></el-table-column>
                ...
                <el-table-column prop="download_count" label="下载次数" align="center"></el-table-column>
       ...
       components: {UE},
        data() {
            return {
                ...
                name:'',
                exportVisible:false,
                action:urlA+'/video/video/uploadVideo',
                filePath:'',
                fileList:[],
                //搜索条件
                 check_state: '',
        ...
        methods: {
            ...
            getData() {
                ...
                filter.pageSize =10;
                if(this.video_id!=''){filter.video_id = this.video_id}
            ...
            // 编辑
            handleEdit(row) {
             this.$router.push({ path: '/video_editor',query: {id:row.video_id}})
            },
            // 去添加和编辑文章
            releaseGo(){
               this.$router.push({ path: '/video_editor'})
            },
              // 下载视频模板
            download(){
           ...
           success(res, file) {
            ...
            // 上传文件
            upload(){
                this.$ajax.postu(urlA+'/video/video/loadVideoExcel',{path:this.filePath}).then((res) => {
                    if (res.msg == "success") {
             ...
             // 确定删除
            deleteRow(){
                 this.$ajax.postu(urlA+'/video/video/deleteVideo',{video_delete_ids:this.idx}).then((res) => {
                    if (res.msg == "success") {
